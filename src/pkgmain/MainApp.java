...
public class MainApp {
	...
	public static void main(String[] args) {
		...
		System.out.println("1- The output chain is with Default "+oCC1 +" number articles : "+oCC1.getCartons().size());
		...
		System.out.println("2- The output chain is with Sort ascending "+oCC2 +" number articles : "+oCC2.getCartons().size());
		...
		System.out.println("3- The output chain is with Sort descending "+oCC3 +" number articles : "+oCC3.getCartons().size());
		...
		System.out.println("4- The output chain is with Sort Min Max "+oCC4 +" number articles : "+oCC4.getCartons().size());
		...
		System.out.println("5- The output chain is with Optimal Sort "+oCC5 +" number articles : "+oCC5.getCartons().size());
	}
}
